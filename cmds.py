...
def welcome():
    ...
    print("If you want to exit, you can enter \"exit\" or \"quit\" or \"bye\" after \">>\", or press the close button at y")
    input_z()
def input_z():
    input_zz = input('>>')
    while input_zz == '':
...
def judge_z(input_zz):
    if input_zz == "":
        input_z()
    elif input_zz == "quit" or input_zz == "exit" or input_zz == "bye" or input_zz == "退出":
        if input_zz == "bye":
            print("∟ See you!")
        else:
            print("∟",input_zz, "okay")
